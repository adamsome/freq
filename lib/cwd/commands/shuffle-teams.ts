...
export default async function shuffleTeams(game: FullCwdGameView) {
  ...
  if (!game.settings?.designated_psychic) {
    const psychicsInfo = getNextPsychicsInfo(game.psychic_history, nextPlayers)
    changes.psychic_1 = psychicsInfo.psychic_1
    changes.psychic_2 = psychicsInfo.psychic_2
